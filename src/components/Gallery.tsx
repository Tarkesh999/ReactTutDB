...
const Gallery: React.FC = ():JSX.Element =>  {
  const images= [
    ...
    {id: 1, name: "Harley", imageSrc: "https://images.livemint.com/img/2019/10/08/1600x900/2019-10-07T102129Z_1_LYNXMPEF960L5_RTROPTP_3_HARLEY-DAVIDSON-ELECTRICBIKE_1570505064296_1570505080774.JPG", info: "Harley retro style"},
  ...
  return (
    <div>
      {images.map((img, ind) => <ImageCard imageDetails={img} key={ind}/>)}
    </div>
  );
}
